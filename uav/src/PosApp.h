...
class PosApp : public flair::meta::UavStateMachine {
	...
	enum class BehaviourMode_t {
        ...
        ***********************************************************************************************
        ...
        flair::gui::Tab *CustomGainsTab, *CustomAnglesTab, *CustomPositonTab;


        flair::gui::Tab *setup_obs;
        flair::gui::Tab *graph_obs_01, *graph_obs_02;
        ...
        ////////////    POINTER TO A CLASS FOR OBSTACLE AVOIDANCE       ////////////////////////////
        flair::filter::obsAvoid *obs_01;
